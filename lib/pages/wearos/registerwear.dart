...
class RegisterwearOs extends StatefulWidget {
  const RegisterwearOs({Key? key}) : super(key: key);

  @override
  State<RegisterwearOs> createState() => _RegisterwearOsState();
}

class _RegisterwearOsState extends State<RegisterwearOs> {
